...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class CuentasControllerTests: BasePruebas
    {
        ...
        public async Task CrearUsuario()
        {
            ...
            await CrearUsuarioHelper(nombreBD); //Funcion de crear usuario
        ...
        //Para crear usuarios más rápido
        ...
        //Para construir Cuentas más rápido
        private CuentasController ConstruirCuentasController(string nombreBD)
        {
            ...
            MockAuth(httpContext);//Llamada al último método
            var signInManager = SetupSignInManager(userManager, httpContext);

            var miConfiguracion = new Dictionary<string, string>
            {
                {"JWT:key", "ASDJKNKJN4KJ5N4KJSNDKAJSNDAKSJDNK4J5N43KJ53N4KSNDJASKLDNASD" }
            };
