...
using WebApiPeliculasFinal.Servicios;
...
namespace WebApiPeliculasFinal.Controllers
{
    ...
    public class PeliculasController: CustomBaseController
    {
        ...
        {
            //Retornar las películas que sean recientes o estén en cines (filtrado)
            var top = 5;
        ...
        public async Task<ActionResult<List<PeliculaDTO>>> Filtrar([FromQuery] FiltroPeliculasDTO filtroPeliculasDTO)
        {
            ...
            if (!string.IsNullOrEmpty(filtroPeliculasDTO.CampoOrdenar))
            {
                ...
                {
                    //Dejandolo así se guarda el error pero se puede ejecutar sin problemas
