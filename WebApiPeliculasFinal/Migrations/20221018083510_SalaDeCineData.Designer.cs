...
namespace WebApiPeliculasFinal.Migrations
{
    ...
    [Migration("20221018083510_SalaDeCineData")]
            ...
            modelBuilder.Entity("WebApiPeliculasFinal.Entidades.SalaDeCine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Nombre = "Megarama",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (40.971794084290714 -5.649404124050454)")
                        },
                        new
                        {
                            Id = 6,
                            Nombre = "Van Dyck",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (40.97324768501752 -5.662663686294007)")
                        },
                        new
                        {
                            Id = 7,
                            Nombre = "Regal Sandhill",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (34.15151948360333 -80.87392051970762)")
                        });
                });
